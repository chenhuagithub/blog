      ...
      <div class="login">
        ...
        <el-form  status-icon  label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item>
            ...
            <el-button class="btn" type="primary" @click="submitData()">注册</el-button>
            <el-button class="btn2" @click="reEmpty()">重置</el-button>
            <span class="sp">已经有帐号, <router-link to="/login">去登录</router-link></span>
          </el-form-item>
        </el-form>
      </div>
    ...
    methods:{
      ...
      submitData(){
        ...
        if(this.password == this.passwordagain){
          this.$axios.post('api/blog_war_exploded/blogger/register',qs.stringify({
